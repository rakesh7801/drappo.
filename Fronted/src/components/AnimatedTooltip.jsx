...
export const AnimatedTooltip = ({ items }) => {
  ...
  const x = useMotionValue(0); // Mouse X position
          ...
          <AnimatePresence mode="wait">
            {hoveredIndex === item.id && (
              <motion.div
                ...
                className="absolute -top-16 -left-1/2 z-50 flex flex-col items-center justify-center rounded-md bg-black text-white shadow-xl px-4 py-2"
              >
